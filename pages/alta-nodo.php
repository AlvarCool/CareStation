                  ...
                  <form action="ABC.php" method="POST">
                    <div class="mb-3 pb-3">
                      ...
                      <div class="form-check" style="padding-left: 150px;">
                        ...
                        <input class="form-check-input" type="checkbox" value="1" style="margin-right: 30px; padding:12px;"name="temperatura">
                          Temperatura
                        </label><br>
                        <label class="form-check-label">
                        <input class="form-check-input" type="checkbox" value="1" style="margin-right: 30px; padding:12px;"name="humedad">
                          Humedad
                        </label><br>
                        <label class="form-check-label">
                        ...
                        <label class="form-check-label">
                        <input class="form-check-input" type="checkbox" value="1" style="margin-right: 30px; padding:12px;"name="uv">
                          UV
                        </label>
                      </div>
                    <div class="text-center">
                      <button type="submit" value="crear" class="btn btn-lg btn-primary btn-lg w-70 mt-4 mb-0">CREAR</button>
                    </div>
                  </form>
            </div>
          </div>
